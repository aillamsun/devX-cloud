...
//    private Logger log = Logger.getLogger(BaseCRUDController.class);
    ...
    public LoginUserInfo getLoginUser() {
        ...
        if (null != userObj) {
            ...
            loginUserInfo.setId(userObj.getString("id"));
            loginUserInfo.setUsername(userObj.getString("username"));
            loginUserInfo.setPassword(userObj.getString("password"));
            loginUserInfo.setAuthorities(userObj.getString("authorities"));
...
//                temp1 = matcher.replaceAll("#/script#");
    ...
    public void processMap(Map map) {
        ...
        while (iterator.hasNext()) {
            ...
            String cameHumpKey = key.toLowerCase();
